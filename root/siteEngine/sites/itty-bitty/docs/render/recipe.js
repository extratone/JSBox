        ...
        m("article.recipe", {},
            ...
            m("header",
                ...
                m(".metadata",
                    ...
                    m("a.action.noprint", {
                        title: "Open original",
                        href: json.mainEntityOfPage || json.url,
                        target: "_blank"
                    }, m(".icon.material-icons-outlined", "link")),
                    m("a.action.noprint", {
                        title: "Show steps as list", href: "#", onclick: () => {
                            reformat = !reformat;
                            render();
                            return false;
                        }
                    }, m(".icon.material-icons-outlined", "format_list_numbered")),
                    m("a.action.noprint", {
                        title: "Print",
                        href: "#",
                        onclick: () => window.print()
                    }, m(".icon.material-icons-outlined", "print")),
                ),
