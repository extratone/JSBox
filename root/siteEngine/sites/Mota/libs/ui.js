...
ui.prototype.drawBattleAnimate = function (monsterId, callback) {
    ...
    var mon_hp = monster.hp, mon_atk = monster.atk, mon_def = monster.def, mon_money = monster.money,
        mon_exp = monster.experience, mon_special = monster.special;
    ...
    core.status.boxAnimateObjs = [];
    core.status.boxAnimateObjs.push({
        'bgx': left + right - margin - 40,
        'bgy': top + margin,
        'bgsize': boxWidth,
        'image': core.material.images.enemys,
        'x': left + right - margin - 40 + (boxWidth - 32) / 2,
        'y': top + margin + (boxWidth - 32) / 2,
        'icon': core.material.icons.enemys[monsterId]
    });
    core.drawBoxAnimate();
